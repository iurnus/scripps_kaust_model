...
C-    These are the options when coupled with WW3
C-    stressFromWave      :: if use the wind stress from WW3
C                            =0 : do not use ; =1 : use WW3 wind stress
C-    langmuirScheme      :: which Langmuir mixing scheme to use
C                            =0 : do not use ; =1 : use VR12-MA
C                            =2 : use VR12-EN ; =3 : use LF17
C-    stokesProfile       :: how to parameterize the profile of Stokes drift
C                            =0 : use default option from Breivik 2015 paper
C-    stokesCoriolis      :: if use Stokes-Coriolis force
C                            =0 : do not use ; =1 : use Stokes-Coriolis
C-    stokesAdvection     :: if use Stokes-Advection force
C                            =0 : do not use ; =1 : use Stokes-Advection
     ...
     &        stressFromWave, langmuirScheme,
     &        stokesProfile, stokesCoriolis, stokesAdvection
      ...
      INTEGER debugLevel
      INTEGER plotLevel
      INTEGER stressFromWave
      INTEGER langmuirScheme
      INTEGER stokesProfile
      INTEGER stokesCoriolis
      INTEGER stokesAdvection
