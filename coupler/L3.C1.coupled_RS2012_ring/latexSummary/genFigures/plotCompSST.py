...
mitgcm_uncpl_data1 = MITgcmutils.rdmds(mitgcm_uncpl_result + 'pickup.0000000030')
mitgcm_cpl_data1   = MITgcmutils.rdmds(mitgcm_cpl_result   + 'pickup.0000000030')
mitgcm_uncpl_data2 = MITgcmutils.rdmds(mitgcm_uncpl_result + 'pickup.0000000060')
mitgcm_cpl_data2   = MITgcmutils.rdmds(mitgcm_cpl_result   + 'pickup.0000000060')
...
axarr[0,0].text(-0.20, 1.12, '0100 UTC, Jun 1, 2012',\
                transform=axarr[0,0].transAxes, fontsize=13)
axarr[1,0].text(-0.20, 1.07, '1200 UTC, Jun 1, 2012', \
