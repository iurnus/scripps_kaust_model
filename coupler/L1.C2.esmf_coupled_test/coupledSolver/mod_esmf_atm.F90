...
!
      ...
      if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU,    &
          line=__LINE__, file=FILENAME)) return
      PRINT *, "setting atm grid arrays finished ..."
      atmGridOut = atmGridIn
      PRINT *, "copy atm grid arrays finished ..."

      !! PRINT *, "creating sst field in atm grid..."
      !! field = ESMF_FieldCreate(name="sst", grid=atmGridIn,              &
      !!   typekind=ESMF_TYPEKIND_R8, rc=rc)
      !! if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU,    &
      !!     line=__LINE__, file=FILENAME)) return
      !! PRINT *, "realizing sst field in atm grid..."
      !! call NUOPC_Realize(importState, field=field, rc=rc)
      !! if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU,    &
      !!     line=__LINE__, file=FILENAME)) return

      !! PRINT *, "creating pmsl field in atm grid..."
      !! field = ESMF_FieldCreate(name="pmsl", grid=atmGridIn,            &
      !!   typekind=ESMF_TYPEKIND_R8, rc=rc)
      !! if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU,    &
      !!     line=__LINE__, file=FILENAME)) return
      ...
      !! PRINT *, "creating rsns field in atm grid..."
      !! field = ESMF_FieldCreate(name="rsns", grid=atmGridIn,            &
      !!   typekind=ESMF_TYPEKIND_R8, rc=rc)
      !! if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU,    &
      !!     line=__LINE__, file=FILENAME)) return
      !! call NUOPC_Realize(exportState, field=field, rc=rc)
      ...
      !! PRINT *, "setting atm data..."
      !! call ATM_SetInitData(gcomp, atmGridIn, atmGridIn, rc)
      !! if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU,    &
      !!     line=__LINE__, file=FILENAME)) return
      !! PRINT *, "finished setting atm data..."
