...
mitgcm_uncpl_data1 = MITgcmutils.rdmds(mitgcm_uncpl_result + 'pickup.0000000009')
mitgcm_cpl_data1   = MITgcmutils.rdmds(mitgcm_cpl_result   + 'pickup.0000000009')
mitgcm_uncpl_data2 = MITgcmutils.rdmds(mitgcm_uncpl_result + 'pickup.0000000018')
mitgcm_cpl_data2   = MITgcmutils.rdmds(mitgcm_cpl_result   + 'pickup.0000000018')
...
axarr[1,0].text(-0.20, 1.07, '0200 UTC, Jan 27, 2018', \
